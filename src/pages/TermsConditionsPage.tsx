  ...
  return (
    <div className="min-h-screen bg-cream">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div>
          <h1 className="text-[22px] md:text-2xl font-semibold text-ink mb-4">Terms & Conditions</h1>
          ...
          <div className="space-y-8 text-charcoal leading-relaxed">
            <section>
              <h2 className="text-lg font-semibold text-ink mb-4">Agreement to Terms</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink mb-4">Use of Website</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink mb-4">Account Registration</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink mb-4">Product Information and Availability</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink mb-4">Orders and Payment</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink mb-4">Intellectual Property Rights</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink mb-4">Product Usage and Safety</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink mb-4">Limitation of Liability</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink mb-4">User Reviews and Content</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink mb-4">Links to Third-Party Websites</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink mb-4">Governing Law</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink mb-4">Changes to Terms</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink mb-4">Severability</h2>
              <p>
