    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 md:p-12">
          <h1 className="text-4xl font-bold text-[#211C17] mb-4">Privacy Policy</h1>
          <p className="text-gray-600 mb-8">Last Updated: January 2026</p>

          <div className="space-y-8 text-gray-700 leading-relaxed">
            <section>
              <h2 className="text-2xl font-semibold text-[#211C17] mb-4">Introduction</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#211C17] mb-4">Information We Collect</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#211C17] mb-4">How We Use Your Information</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#211C17] mb-4">Cookies and Tracking Technologies</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#211C17] mb-4">Data Sharing and Disclosure</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#211C17] mb-4">Data Security</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#211C17] mb-4">Your Rights and Choices</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#211C17] mb-4">Data Retention</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#211C17] mb-4">Children's Privacy</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#211C17] mb-4">Changes to This Privacy Policy</h2>
              <p>
