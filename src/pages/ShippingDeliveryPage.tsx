  ...
  return (
    <div className="min-h-screen bg-cream">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div>
          <h1 className="text-[22px] md:text-2xl font-semibold text-ink mb-4">Shipping & Delivery Policy</h1>
          ...
          <div className="space-y-8 text-charcoal leading-relaxed">
            <section>
              <h2 className="text-lg font-semibold text-ink mb-4">Shipping Overview</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink mb-4">Order Processing Time</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink mb-4">Shipping Methods and Delivery Times</h2>
              <p className="mb-3">We offer the following shipping options:</p>
              <div className="space-y-4">
                <div className="bg-sage-tint p-4 rounded-lg">
                  <h3 className="font-semibold text-ink mb-2">Standard Shipping</h3>
                ...
                <div className="bg-sage-tint p-4 rounded-lg">
                  <h3 className="font-semibold text-ink mb-2">Express Shipping</h3>
                  <ul className="list-disc pl-6 space-y-1">
                ...
                <div className="bg-sage-tint p-4 rounded-lg">
                  <h3 className="font-semibold text-ink mb-2">Overnight Shipping</h3>
                  <ul className="list-disc pl-6 space-y-1">
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink mb-4">Shipping Costs</h2>
              <p className="mb-3">
              ...
              <div className="bg-ochre/10 border border-ochre p-4 rounded-lg mt-4">
                <p className="font-semibold text-ink">Free Shipping Available!</p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink mb-4">Shipping Locations</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink mb-4">Order Tracking</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink mb-4">Delivery Attempts and Failed Deliveries</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink mb-4">Damaged or Lost Packages</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink mb-4">Delivery Responsibility</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink mb-4">Special Delivery Instructions</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink mb-4">Holiday Shipping</h2>
              <p>
