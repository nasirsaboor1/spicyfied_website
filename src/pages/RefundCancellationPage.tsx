    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 md:p-12">
          <h1 className="text-4xl font-bold text-[#2d5016] mb-4">Cancellation & Refund Policy</h1>
          <p className="text-gray-600 mb-8">Last Updated: January 2026</p>

          <div className="space-y-8 text-gray-700 leading-relaxed">
            <section>
              <h2 className="text-2xl font-semibold text-[#2d5016] mb-4">Order Cancellation Policy</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#2d5016] mb-4">Delivery and Liability</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#2d5016] mb-4">Refunds for Cancellations</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#2d5016] mb-4">Fraudulent Transactions and Misuse</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#2d5016] mb-4">Contact and Support</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[#2d5016] mb-4">Policy Modifications</h2>
              <p>
