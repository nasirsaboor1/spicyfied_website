...
const SPICES: FloatingSpice[] = [
  { Icon: CinnamonIcon, top: '12%', left: '8%', size: 46, rotate: -18, duration: 11, delay: 0, opacity: 0.35 },
  { Icon: CardamomIcon, top: '62%', left: '6%', size: 44, rotate: 8, duration: 9, delay: 1.2, opacity: 0.4 },
  { Icon: CloveIcon, top: '20%', right: '9%', size: 34, rotate: 14, duration: 10, delay: 0.6, opacity: 0.4 },
  { Icon: CardamomIcon, top: '66%', right: '7%', size: 40, rotate: -10, duration: 12, delay: 2, opacity: 0.32 },
  { Icon: CinnamonIcon, top: '4%', right: '22%', size: 30, rotate: 24, duration: 13, delay: 0.9, opacity: 0.28 },
];
  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
      {SPICES.map(({ Icon, top, left, right, size, rotate, duration, delay, opacity }, i) => (
        <div
          key={i}
          className="motion-safe:animate-spice-float absolute text-saffron-light"
          style={
            {
              top,
              left,
