const PARTICLES = [
  ...
  { left: '18%', size: 5, color: 'bg-moss-light', duration: 16, delay: 1, opacity: 0.5, driftX: 14 },
  ...
  { left: '44%', size: 7, color: 'bg-moss', duration: 18, delay: 3, opacity: 0.45, driftX: -20 },
  ...
  { left: '77%', size: 4, color: 'bg-moss-light', duration: 10, delay: 0, opacity: 0.45, driftX: -14 },
