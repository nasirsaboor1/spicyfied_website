          ...
          {cart.length > 0 && (
            <div className="border-t border-gray-200 p-6 space-y-4">
              ...
              <div className="flex justify-between items-center text-xl font-bold">
                ...
                <span className="text-[#2d5016]">₹{Math.round(getTotalPrice())}</span>
              </div>
              <button
                onClick={() => {
                ...
                className="w-full bg-[#2d5016] text-white py-4 rounded-lg font-semibold text-lg hover:bg-[#1f3910] transition-colors shadow-lg"
              >
                Proceed to Checkout
              </button>
              <button
